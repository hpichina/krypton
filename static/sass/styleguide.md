# Styleguide for the krypton theme
...
This styleguide for the krypton Drupal theme is generated with `KSS`, a
stylesheet parser,
[Spec available](https://github.com/kss-node/kss/blob/spec/SPEC.md).

The krypton theme is a subtheme based on
...
file found in the `static/sass` directory of the krypton drupal theme.*
